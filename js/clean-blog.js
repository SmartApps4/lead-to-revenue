 ...
 * twitter-share.js
 *
 * Open a popup window to share something on twitter
 */

(function (window, $) {

    var $window = $( window ),
        $target = $( '.social-sharing-button' ),
        $tweetItWrapper = $( '.tweet-it-wrapper' );
        // eventClick = isMobile() ? 'touchstart' : 'click'; // Just detect if it's a mobile device and then change the event

    /**
     * Open a popup window with a given url.
     */
    var sharingPopup = function( url, title, w, h ) {
...
//         sharingPopup( url, 'Share something', 700, 475 );

//     } );

//     $window.scroll( function() {
//             if( isScrolledIntoView( '.pager' ) && !$tweetItWrapper.hasClass( 'no-tweet-it-bro' ) ) {
//                 $tweetItWrapper.addClass( 'tweet-it-bro' );
//             }
//     } );

//     /**
//      * Close the tweet-it sharebox
//      */
//     $( '.tweet-it-close' ).on( 'click', function(e) {
//         e.preventDefault();

//         $tweetItWrapper
//             .removeClass( 'tweet-it-bro' )
//             .addClass( 'no-tweet-it-bro' );
...
$(function() {
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "http://formspree.io/jberry@smartapps4.com",
                type: "POST",
                data: {
